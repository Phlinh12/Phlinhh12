                            ...
                            <div class="card-body">
                                <form method="POST" action="tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="file" class="form-control" id="txtAnhMinhHoaCT" name="txtAnhMinhHoaCT"  />
                                                <label for="txtAnhMinhHoaCT">Ảnh chi tiết</label>
                                        </div>
                                    <div class="form-floating mb-3" >
                                        ...
                                        {
                                        ;?>
                                            <option value="<?php echo $row["chu_de_id"];?>"><?php echo $row["chu_de"];?></option>
                                        <?php
                                        }
                                        ;?>
                                        </select>
