                        ...
                        <div class="card mb-4">
                            ...
                            ;?>
                                <form method="POST" action="tin_tuc_sua_thuc_hien.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTacGia" name="txtTacGia" placeholder="Tác giả bài viết" value="<?php echo $row['tac_gia'];?>" />
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        while ($chude=mysqli_fetch_array($ket_qua)) 
                                        if($chude['chu_de_id']==$row['chu_de_id']){
                                        ?>  
                                        <option selected="selected" value="<?php echo $row['chu_de_id'] ?>"><?php echo $chude['chu_de']?></option> 
                                    <?php } else { ?>                           
                                        <option value="<?php echo $chude['chu_de_id']?>"><?php echo $chude['chu_de'];?></option>  
                                        <?php
                                    }?> 
