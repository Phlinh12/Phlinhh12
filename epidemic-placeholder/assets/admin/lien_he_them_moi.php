                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="lien_he_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTen" name="txtTen" placeholder="ên người liên hệ" />
                                            <label for="txtTen">Tên người liên hệ</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtEmail" name="txtEmail" placeholder="name@example.com" />
                                            <label for="txtEmail">Email</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtSDT" name="txtSDT" placeholder="Số điện thoại của người liên hệ" />
                                            <label for="txtSDT">Số điện thoại </label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtNoiDung" name="txtNoiDung" placeholder="Nội dung liên hệ" />
                                            <label for="txtNoiDung">Nội dung liên hệ</label>
                                    </div>
                                </div>
                                    
                                <div class="mt-4 mb-0">
                                    <div class="d-grid"><button type="submit">Đăng bài</button></a></div>
                                        </div>
                                    </form>    
                            </div>
                        </div>
