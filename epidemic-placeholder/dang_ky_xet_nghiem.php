    ...
    <section class="breadcrumb_area boi_breadcrumb">
      <div class="container">
        <div class="breadcrumb_text">
          ...
          <h3 class="wow fadeInUp" data-wow-delay="0.2s">Đăng ký xét nghiệm</h3>
        ...
        <div class="row appointment_box">
          <div class="col-lg-4 appoinment_features">
            ...
            src="assets/images/appoinment/POSTER-CHONG-COVID_110x200cm-01-1.jpg" alt=""/>
          ...
          <div class="col-lg-8">
            <form action="#" class="appoinment_form">
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <input class="form-control" type="text" id="txtHoten" name="txtHoten" placeholder="" />
                ...
                <!--<div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <label><i class="linearicons-user"></i>Giới tính</br>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <input class="form-control" type="text" id="txtSDT" name="txtSDT" placeholder="" />
                  ...
                  <div class="form-group select_conversation_inner" >
                    <h5>Chọn phương thức thanh toán</h5>
                     <div>
                        <div class="select_conversation"> 
                      <input type="radio" name="conversation" id="voice" value="voice" />
                      <label for="voice">Thanh toán trực tiếp</label>
                    </div>
                        <div class="select_conversation"> 
                      <input type="radio" name="conversation" id="voice" value="voice" />
                      <label for="voice">VNPay</label>
                    </div></div>
